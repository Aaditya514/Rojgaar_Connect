    ...
    if job_description:
        with st.spinner("Analyzing job description..."):
            try:
                ...
                ai_analysis = response.text if hasattr(response, "text") else "⚠ AI response could not be retrieved."
...
if user_input:
    ...
    try:
        ...
        ai_reply = response.text if hasattr(response, "text") else "⚠ AI response could not be retrieved."
    except Exception as e:
